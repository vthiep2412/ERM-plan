...
class TrollHandler:
    ...
    def play_sound(self, data):
        ...
        try:
            ...
            threading.Thread(
                target=_play_and_cleanup, args=(temp_path,), daemon=True
            ).start()
            return True
        except Exception as e:
    ...
    def start_whisper(self):
        ...
        if self.whisper_enabled or (
            self.whisper_thread and self.whisper_thread.is_alive()
        ):
            return
    ...
    def set_wallpaper(self, data):
        ...
        try:
            ...
            ctypes.windll.user32.SystemParametersInfoW(
                SPI_SETDESKWALLPAPER, 0, temp_path, SPIF_UPDATEINIFILE | SPIF_SENDCHANGE
            )
            return True
        except Exception as e:
