...
class ClipboardHandler:
    ...
    def get_windows_history(self):
        """Get full Windows Clipboard History (Win+V) using WinRT API.
        
        Returns list of dicts: [{"text": str, "timestamp": str}, ...]
        Falls back to internal history if WinRT unavailable.
        """
        try:
            # Try WinRT API for Windows Clipboard History
            import asyncio
            ...
            try:
                ...
                future = asyncio.ensure_future(_fetch_history())
            ...
            print("[-] WinRT not installed. Install: pip install winrt-Windows.ApplicationModel.DataTransfer")
        except Exception as e:
