    ...
    try:
        ...
        if opcode == protocol.OP_HELLO:
            ...
            if direct_url:
                ...
                try:
                    await send_msg(websocket, bytes([protocol.OP_ERROR]) + b"Agent Disconnected")
                except:
                    pass
                
            else:
                await send_msg(websocket, bytes([protocol.OP_ERROR]) + b"Target Not Found")
        ...
        if client_id:
            ...
            if client_id in direct_routes: del direct_routes[client_id]
