...
class BSODScreen:
    ...
    def __init__(self):
        ...
        # Sad face
        sad_face = tk.Label(frame, text=":(", font=("Segoe UI", 120), 
                           fg="white", bg='#0078D7')
        sad_face.pack()
        
        # Main text
        main_text = tk.Label(frame, 
            text="Your PC ran into a problem and needs to restart.\nWe're just collecting some error info, and then we'll\nrestart for you.",
            font=("Segoe UI", 20), fg="white", bg='#0078D7', justify='left')
        main_text.pack(pady=(40, 30))
        
        # Progress
        self.progress = 0
        self.progress_label = tk.Label(frame, text="0% complete",
            font=("Segoe UI", 16), fg="white", bg='#0078D7')
        ...
        qr_text = tk.Label(qr_frame, text="QR", font=("Consolas", 30), fg="black", bg="white")
        qr_text.place(relx=0.5, rely=0.5, anchor='center')
        
        # Error info
        error_text = tk.Label(frame,
            text="For more information about this issue and possible fixes, visit\nhttps://www.windows.com/stopcode\n\nIf you call a support person, give them this info:\nStop code: CRITICAL_PROCESS_DIED",
            font=("Segoe UI", 12), fg="white", bg='#0078D7', justify='left')
